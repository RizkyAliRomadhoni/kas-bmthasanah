<x-app-layout>
    ...
    <main class="main-content max-height-vh-100 h-100">
        ...
        <div class="container my-3 py-3">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card blur border border-white mb-4 shadow-xs">
                        <div class="card-body p-4">
                            ...
                            <p class="text-sm mb-1">Writting</p>
                            <h3 class="mb-0 font-weight-bold">Menulis</h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="card-body p-4">
                            <div
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" height="19" width="19"
                                    ...
                                    <path
                                        d="M6.5 17A2.5 2.5 0 0 0 4 19.5V2a2 2 0 0 1 2-2h13a2 2 0 0 1 2 2v15" />
                                </svg>
                            </div>
                            <p class="text-sm mb-1">Reading</p>
                            <h3 class="mb-0 font-weight-bold">Membaca</h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="card-body p-4">
                            <div
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" height="19" width="19"
                                    viewBox="0 0 24 24" fill="currentColor">
                                    <path
                                        d="M12 3C7.03 3 3 7.03 3 12v6c0 1.1.9 2 2 2h2c1.1 0 2-.9 2-2v-3c0-1.1-.9-2-2-2H5v-1c0-3.87 3.13-7 7-7s7 3.13 7 7v1h-2c-1.1 0-2 .9-2 2v3c0 1.1.9 2 2 2h2c1.1 0 2-.9 2-2v-6c0-4.97-4.03-9-9-9z" />
                                </svg>
                            </div>
                            <p class="text-sm mb-1">Listening</p>
                            <h3 class="mb-0 font-weight-bold">Mendengar</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="d-md-flex align-items-center mb-4">
                        <div class="mb-md-0 mb-3">
                            <h5 class="font-weight-semibold mb-1">Modul Belajar Bahasa Inggris </h5>
                            <p class="text-sm mb-0">Download modul untuk acuan pengerjaan soal anda!!</p>
                        </div>
                        <button type="button"
            ...
            <div class="row">
                <div class="col-md-4">
                    <h6 class="text-sm font-weight-semibold mb-1">Latihan Yang Tersedia</h6>
                    <p class="text-sm">Pilih Latihan Soal yang disediakan <br> Asah kemampuan berbahasa inggris anda!!
                    </p>
                </div>
                    ...
                    <div class="card shadow-xs border mb-4">
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                    <th class="text-secondary text-xs font-weight-semibold opacity-7 ps-2">Latihan
                                    </th>
                                        <th class="text-secondary text-xs font-weight-semibold opacity-7 ps-2">Status
                                        </th>
                                        <th class="text-secondary text-xs font-weight-semibold opacity-7 ps-2">Point
                                        </th>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="d-flex align-items-center py-3 px-4 text-sm">
                                            ...
                                            <span class="font-weight-semibold text-dark ms-1">Greetings (Salam)</span>
                                        </td>
                                        <td>
                                            <span
                                        ...
                                        <td>
                                        <button class="btn btn-primary text-sm font-weight-semibold text-light">Start</button>
                                    </td>
                                    </tr>
                                    <tr>
                                        <td class="d-flex align-items-center py-3 px-4 text-sm">
                                            ...
                                            <span class="font-weight-semibold text-dark ms-1">Numbers (Angka)</span>
                                        </td>
                                        <td>
                                            <span
                                                class="badge badge-sm border border-success text-success bg-success border-radius-sm">
                                    ...
                                    <tr>
                                        <td class="d-flex align-items-center py-3 px-4 text-sm">
                                            ...
                                            <span class="font-weight-semibold text-dark ms-1">Colors (Warna)</span>
                                        </td>
                                        <td>
                                            <span
                                                class="badge badge-sm border border-success text-success bg-success border-radius-sm">
                                    ...
                                    <tr>
                                        <td class="d-flex align-items-center py-3 px-4 text-sm">
                                            ...
                                            <span class="font-weight-semibold text-dark ms-1">Days of the Week (Hari)</span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <span class="text-sm">Writting</span>
                                        </td>
                                        <td>
                                        <button class="btn btn-primary text-sm font-weight-semibold text-light">Start</button>
                                    </td>
                                    ...
                                    <tr>
                                        <td class="d-flex align-items-center py-3 px-4 text-sm">
                                            ...
                                            <span class="font-weight-semibold text-dark ms-1"> Animals (Hewan)</span>
                                        </td>
                                        <td>
                                            <span
                                                class="badge badge-sm border border-success text-success bg-success border-radius-sm">
                                    ...
                                    <tr>
                                        <td class="d-flex align-items-center py-3 px-4 text-sm">
                                            ...
                                            <span class="font-weight-semibold text-dark ms-1">Simple Sentences (Kalimat Sederhana)</span>
                                        </td>
                                        <td>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="d-flex align-items-center py-3 px-4 text-sm">
                                            ...
                                            <span class="font-weight-semibold text-dark ms-1"> Basic Verbs (Kata Kerja Dasar)</span>
                                        </td>
                                        <td>
                                ...
                                <div class="card-body py-0">
                                    <div class="row">
                                        ...
                                        <div class="col-8 my-auto">
                                            <div class="d-flex">
                                                <div>
                                                    <h4 class="font-weight-semibold text-lg mb-4">Writting Points</h4>
                                                    <p class="text-sm mb-1">Poin Menulis</p>
                                                    <h3 class="mb-0 font-weight-bold">325 Pts</h3>
                                                </div>
                                ...
                                <div class="card-body py-0">
                                    <div class="row">
                                        ...
                                        <div class="col-8 my-auto">
                                            <div class="d-flex">
                                                <div>
                                                    <h4 class="font-weight-semibold text-lg mb-4">Reading Points</h4>
                                                    <p class="text-sm mb-1">Poin Membaca</p>
                                                    <h3 class="mb-0 font-weight-bold">350 pts</h3>
                                                </div>
                                                <div class="ms-auto text-end d-flex flex-column">
                                                    <div class="dropdown">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24"
  ...
  <path d="M16.5 3.5a2.121 2.121 0 1 1 3 3L7 19.5l-4 1 1-4L16.5 3.5z"></path>
                    ...
                    <div class="col-8 my-auto">
                        <div class="d-flex">
                            <div>
                                <h4 class="font-weight-semibold text-lg mb-4">Listening Points</h4>
                                <p class="text-sm mb-1">Poin Mendengar</p>
                                <h3 class="mb-0 font-weight-bold">300 Pts</h3>
                            </div>
                            <div class="ms-auto text-end d-flex flex-column">
                                <div class="dropdown">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="currentColor"
                                        class="ms-auto cursor-pointer dropdown-toggle" data-bs-toggle="dropdown"
                                        aria-expanded="false">
                                        <path fill-rule="evenodd"
                                            d="M10.5 6a1.5 1.5 0 113 0 1.5 1.5 0 01-3 0zm0 6a1.5 1.5 0 113 0 1.5 1.5 0 01-3 0zm0 6a1.5 1.5 0 113 0 1.5 1.5 0 01-3 0z"
                                            clip-rule="evenodd" />
                ...
                <div class="col-12">
                    <div class="d-md-flex align-items-center mb-4">
                        <div class="mb-md-0 mb-4">
                            <h5 class="mb-1 font-weight-bold ">Your Reward🎉🎉</h5>
                            <p class="text-sm mb-0">Penukaran Poin dengan Hadiah-Hadiah Menarik </p>
                        </div>

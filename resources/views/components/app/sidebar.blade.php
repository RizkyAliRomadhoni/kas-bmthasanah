    ...
    <ul class="navbar-nav">
            ...
            <a class="nav-link {{ is_current_route('dashboard') ? 'active' : '' }}"
               href="{{ route('dashboard') }}">
                <div class="icon icon-sm text-white d-flex align-items-center justify-content-center">
                    <svg width="26px" height="26px" viewBox="0 0 48 48" fill="none">
        ...
        <li class="nav-item mt-3">
            <div class="nav-link d-flex align-items-center text-white opacity-8">
                <svg width="16" viewBox="0 0 24 24" fill="#ffffff">
                    <path d="M18.7 19.1A9.7 9.7 0 0021.8 12a9.7 9.7 0 10-19.4 0 9.7 9.7 0 003.1 7.1A9.7 9.7 0 0012 21.8c2.6 0 5-.9 6.7-2.7zM12 15a7.5 7.5 0 015.9 2.8A8.2 8.2 0 0112 20.3a8.2 8.2 0 01-5.9-2.4A7.5 7.5 0 0112 15zm0-6a3.7 3.7 0 110 7.5 3.7 3.7 0 010-7.5z"/>
                </svg>
...
<div id="sidenav-overlay"
     ...
     style="background: rgba(0,0,0,0.4); z-index: 998;">
</div>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // OPEN SIDENAV (trigger via navbar burger)
    ...
    if (iconClose) iconClose.onclick = closeSidenav;

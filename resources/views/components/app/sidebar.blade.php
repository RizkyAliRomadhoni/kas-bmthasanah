<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <ul class="navbar-nav">
                    ...
                    <div
                        ...
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            ...
                            <g id="wallet" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g id="credit-card" transform="translate(12.000000, 15.000000)" fill="#FFFFFF">
                                    <path class="color-background"
                                        d="M5 3v18a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1H6a1 1 0 0 0-1 1zm2 1h12v16H7V4zm2 2v2h8V6H9zm0 4v2h8v-2H9zm0 4v2h8v-2H9z"
                                        id="Path" fill-rule="nonzero"></path>
                                </g>
                            </g>
                        </svg>
            ...
            <li class="nav-item">
                <a class="nav-link {{ is_current_route('kambing.index') ? 'active' : '' }} " href="{{ route('farm.index') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            ...
                            <g id="wallet" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g id="credit-card" transform="translate(12.000000, 15.000000)" fill="#FFFFFF">
                                    <path class="color-background"
                                        d="M12 3C6.477 3 2 6.686 2 11c0 1.872.796 3.597 2.138 4.962L2 20.5a1 1 0 0 0 1.516.858L7 18.5A11.07 11.07 0 0 0 12 19c5.523 0 10-3.686 10-8S17.523 3 12 3z"
                                        id="Path" fill-rule="nonzero"></path>
                                </g>
                            </g>
                        </svg>
            ...
            <li class="nav-item mt-2">
                <div class="d-flex align-items-center nav-link">
                    ...
                    <span class="font-weight-normal text-md ms-2">User Pages</span>
                </div>
            </li>
            ...
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('users-management') ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">User Activity</span>
                </a>
            </li>
            <li class="nav-item mt-2">
                <div class="d-flex align-items-center nav-link">
                    ...
                    <span class="font-weight-normal text-md ms-2">Register</span>
                </div>
            </li>
            <li class="nav-item border-start my-0 pt-2">

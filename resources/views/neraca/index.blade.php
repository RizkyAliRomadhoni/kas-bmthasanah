<x-app-layout>
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        <div class="container-fluid py-4">
            ...
            <div class="row align-items-center mb-4">
                ...
                <div class="col-md-6 col-12 d-flex justify-content-md-end gap-2 mt-3 mt-md-0">
                    
                    <!-- MENU DROPDOWN KELOLA AKUN -->
                    <div class="dropdown">
                        <!-- Menggunakan data-bs-toggle dan data-toggle agar aman di semua versi -->
                        <button class="btn btn-sm btn-white dropdown-toggle shadow-sm mb-0 text-dark font-weight-bold" 
                                type="button" 
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 p-2" aria-labelledby="dropdownMenuButton" style="z-index: 9999 !important;">
                            <li><a class="dropdown-item border-radius-md text-xs" href="{{ route('kambing-akun.index') }}"><i class="fas fa-sheep me-2 text-dark"></i>Stok Kambing</a></li>
                            <li><a class="dropdown-item border-radius-md text-xs" href="{{ route('pakan.index') }}"><i class="fas fa-utensils me-2 text-warning"></i>Pakan</a></li>
                            <li><a class="dropdown-item border-radius-md text-xs" href="{{ route('kandang.index') }}"><i class="fas fa-tools me-2 text-info"></i>Kandang</a></li>
                            <li><a class="dropdown-item border-radius-md text-xs" href="{{ route('upah.index') }}"><i class="fas fa-user-tie me-2 text-dark"></i>Upah Tenaga Kerja</a></li>
                            <li><a class="dropdown-item border-radius-md text-xs" href="{{ route('perlengkapan.index') }}"><i class="fas fa-box me-2 text-primary"></i>Perlengkapan</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item border-radius-md text-xs" href="{{ route('piutang.index') }}"><i class="fas fa-file-invoice-dollar me-2 text-success"></i>Piutang</a></li>
                            <li><a class="dropdown-item border-radius-md text-xs" href="{{ route('hutang.index') }}"><i class="fas fa-hand-holding-usd me-2 text-danger"></i>Hutang</a></li>
                            <li><a class="dropdown-item border-radius-md text-xs" href="{{ route('operasional.index') }}"><i class="fas fa-cogs me-2 text-secondary"></i>Operasional Lainnya</a></li>
                        </ul>
                    </div>

                    <a href="{{ route('neraca.penjualan.index') }}" class="btn btn-sm btn-white shadow-sm mb-0 font-weight-bold text-dark">
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            {{-- TOTAL AKTIVA --}}
                            <tr class="fw-bold bg-gray-50 border-top">
                            ...
                            {{-- TOTAL PASIVA --}}
                            <tr class="fw-bold bg-warning-light border-top">
                ...
                <div class="col-md-4 col-12">
                    <div class="card card-body border-0 shadow-sm p-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3">
                                <p class="text-xs mb-0 text-capitalize font-weight-bold text-secondary">Kas Tunai Saat Ini</p>
    ...
    <!-- JAVASCRIPT MANUAL UNTUK MEMASTIKAN DROPDOWN BERJALAN -->
    @push('js')
    <script>
...
<style>
    ...
    .btn-white { background-color: white; color: #344767; border: 1px solid #e2e8f0; }
    .dropdown-item { font-size: 0.75rem !important; padding: 10px 15px !important; color: #344767 !important; }
    .dropdown-item:hover { background-color: #f8f9fa; color: #5e72e4 !important; }
    .dropdown-item i { width: 20px; text-align: center; margin-right: 5px; }
    /* Memastikan dropdown tampil di atas tabel */
    .dropdown-menu.show { display: block; position: absolute; }
</style>
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        <div class="container-fluid py-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h5 class="fw-bold mb-0">AKUN: OPERASIONAL</h5>
                <div class="d-flex gap-2">
                    <form action="{{ route('operasional.index') }}" method="GET" class="d-flex gap-2">
                        ...
                        <table class="table table-bordered align-items-center mb-0">
                            <thead class="bg-gray-100">
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">CATATAN TAMBAHAN</th>
                                    <th class="text-end text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 pe-4">HARGA (Kas)</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <form action="{{ route('operasional.update') }}" method="POST">
                                        @csrf
                                        ...
                                        <td class="text-xs ps-3 font-weight-bold">
                                            {{ strtoupper($item->keterangan) }}
                                        </td>
                                        <td>
                                            <input type="text" name="catatan" 
                                                class="form-control form-control-sm text-xs mx-auto" 
                                                placeholder="..."
                                                value="{{ $item->operasionalDetail->catatan ?? '' }}">
                                        </td>
                                ...
                                @empty
                                <tr>
                                    <td colspan="6" class="text-center py-5 text-xs">Data tidak ditemukan. Pastikan akun di Kas bernama "Operasional"</td>
                                </tr>
                                @endforelse
                            </tbody>
                            <tfoot class="bg-gray-50 fw-bold">
                                <tr>
                                    <td colspan="4" class="text-end text-xs pe-3 text-uppercase">Total Pengeluaran Operasional :</td>

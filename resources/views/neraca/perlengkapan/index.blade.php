    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        <div class="container-fluid py-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h5 class="fw-bold mb-0">AKUN: PERLENGKAPAN</h5>
                        ...
                        <table class="table table-bordered align-items-center mb-0">
                            <thead class="bg-gray-100">
                                <tr>
                                    ...
                                    <th class="text-center text-uppercase text-primary text-xxs font-weight-bolder opacity-7" style="width: 120px;">QTY (Manual)</th>
                            ...
                            <tbody>
                                ...
                                @empty
                                <tr>
                                    <td colspan="6" class="text-center py-5 text-xs">Data tidak ditemukan. Pastikan akun di Kas bernama "Perlengkapan"</td>
                                </tr>
                                @endforelse
                            </tbody>

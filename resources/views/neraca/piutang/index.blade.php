    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        <div class="container-fluid py-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h5 class="fw-bold mb-0 text-uppercase">AKUN: PIUTANG (PENJUALAN)</h5>
                <div class="d-flex gap-2">
                    <form action="{{ route('piutang.index') }}" method="GET" class="d-flex gap-2">
                        ...
                        <table class="table table-bordered align-items-center mb-0">
                            <thead class="bg-gray-100">
                                <tr class="text-center">
                                    ...
                                    <th class="text-uppercase text-danger text-xxs font-weight-bolder opacity-7">DEBET (-)</th>
                                    <th class="text-uppercase text-success text-xxs font-weight-bolder opacity-7">KREDIT (+)</th>
                                    <th class="text-uppercase text-dark text-xxs font-weight-bolder opacity-7">SALDO PIUTANG</th>
                                    <th class="text-secondary opacity-7" style="width: 100px;">AKSI</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="ps-3 text-xs">
                                        <form action="{{ route('piutang.update') }}" method="POST" class="d-flex align-items-center m-0">
                                            @csrf
                                            ...
                                            <div class="w-100">
                                                ...
                                                <input type="text" name="catatan" class="form-control form-control-sm border-0 p-0 text-xxs italic" 
                                                       ...
                                                       value="{{ $item->piutangDetail->catatan ?? '' }}">
                                            </div>
                                    </td>
                                ...
                                @empty
                                <tr>
                                    <td colspan="7" class="text-center py-5 text-xs">Data tidak ditemukan. Gunakan akun "Piutang" di Kas.</td>
                                </tr>
                                @endforelse
                            </tbody>
                            <tfoot class="bg-gray-100 fw-bold">
                                <tr>
                                    <td colspan="5" class="text-end text-xs pe-3 text-uppercase">Total Piutang Belum Tertagih :</td>

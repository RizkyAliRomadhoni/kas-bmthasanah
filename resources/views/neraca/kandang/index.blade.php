    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        <div class="container-fluid py-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h6 class="fw-bold mb-0">AKUN: KANDANG</h6>
                <form action="{{ route('kandang.index') }}" method="GET" class="d-flex gap-2">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-xs ps-4">
                                        ...
                                        <div class="text-xxs text-muted">{{ \Carbon\Carbon::parse($item->tanggal)->format('d/m/Y') }}</div>
                                    </td>
                                ...
                                @empty
                                <tr>
                                    <td colspan="3" class="text-center py-4 text-xs">Belum ada transaksi kandang.</td>
                                </tr>
                                @endforelse
                            </tbody>
                            <tfoot class="bg-gray-50 fw-bold">
                                <tr>
                                    <td colspan="2" class="text-end text-xs pe-3">TOTAL :</td>

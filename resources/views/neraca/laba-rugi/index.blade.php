    ...
    <div class="container-fluid py-4">
        ...
        <div class="card shadow-sm border-0 border-radius-xl mb-4">
            <div class="card-body p-3">
                <h6 class="text-primary fw-bold mb-3 text-sm"><i class="fas fa-edit me-2"></i> Form Input Data Manual</h6>
                <form action="{{ route('neraca.laba-rugi.store-manual') }}" method="POST" class="row g-2 align-items-end">
                    ...
                    <div class="col-md-3">
                        <label class="text-xxs fw-bold">Pilih Baris Akun</label>
                    ...
                    <div class="col-md-3">
                        <label class="text-xxs fw-bold">Masukkan Nilai Rp (Gunakan "-" jika rugi)</label>
                        <input type="number" name="nilai" class="form-control form-control-sm" required placeholder="Contoh: -1500000">
                    </div>
                    <div class="col-md-3">
        ...
        <div class="card shadow-sm border-0 border-radius-xl">
            <div class="card-body p-4">
                ...
                @if(session('success'))
                    <div class="alert alert-success text-white text-xs py-2 mb-4 border-radius-lg">{{ session('success') }}</div>
                @endif
                ...
                <div class="table-responsive">
                    <table class="table table-bordered align-middle">
                        <thead class="bg-gray-100 text-center">
                            <tr>
                                <th class="text-start ps-4 py-3 text-xs font-weight-bold" style="width: 250px;">KETERANGAN AKUN</th>
                                @foreach($bulanList as $bulan)
